/**
 * Qwen Model Adapter (Alibaba Cloud DashScope)
...
export class QwenAdapter extends BaseModelAdapter {
  private endpoint = 'https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions'
        ...
        for (const line of lines) {
          if (line.startsWith('data:')) {
            ...
            try {
              ...
              console.error('Error parsing Qwen SSE:', e)
            }
          }
        }
      }
